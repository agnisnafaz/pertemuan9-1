...
public class ActivityDetailContact extends AppCompatActivity {
    ...
    private void readData() {
        firebaseFirestore.collection("Contacts").whereEqualTo("telepon", teleponId).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()){
                    ...
                    Toast.makeText(ActivityDetailContact.this, "Errpr getting documents", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
